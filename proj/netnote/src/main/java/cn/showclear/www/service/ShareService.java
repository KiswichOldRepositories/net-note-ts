...
public interface ShareService<T> {
     ...
     * @return 笔记集合的json字符串
     */
    List<T> showShareByUsername(String username);
     ...
     * @return 笔记集合的json字符串
     */
    List<T> showShareByUrl(String url);
     ...
     * @param username 请求者的用户名
     */
    void deleteShare(int shareId,String username);
     ...
     * @param username 请求者的用户名
     */
    Share addShare(int DirectoryOdNoteId, int shareType, String username);
}
