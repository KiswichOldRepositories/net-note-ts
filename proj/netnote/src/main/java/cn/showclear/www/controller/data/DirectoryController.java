...
public class DirectoryController {
    ...
    public List<ZTreeNode> getDirectoryByUsernameZtree(HttpSession session){
        String username = (String) session.getAttribute("username");
        return zTreeDirService.showDirectories(username);
    ...
    public APIObjectJson addDirectory(HttpServletRequest request, @PathVariable int pid, String name) {
        ...
        Directory directory = directoryService.addDirectory((pid - 1) / 2, name, username);
    ...
    public APIObjectJson patchDirectory(HttpSession session, @PathVariable int mid, String name, Integer parentId) {
        ...
        String username = (String) session.getAttribute("username");
        Directory directory1 = directoryService.editDirectory(directory, username);
        return new APIObjectJson(ResultCode.SUCC,directory1);
