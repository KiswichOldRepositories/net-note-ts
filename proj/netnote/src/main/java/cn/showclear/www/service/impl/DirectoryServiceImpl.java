...
public class DirectoryServiceImpl implements DirectoryService {
     ...
     */
    @Override
    public List<EasyUiTreeEntiy> showDirectories(String username) {
    ...
    public Directory addDirectory(int parentDirectoryId, String newDirectoryName, String username) {
        ...
        User user = userDao.selectUserByUsername(username);
        if (user.getId() != directory.getUserId()) return null;
    ...
    public Directory editDirectory(Directory directory, String username) {
        ...
        if (user.getId() != exitDirectory.getUserId()) return null;
