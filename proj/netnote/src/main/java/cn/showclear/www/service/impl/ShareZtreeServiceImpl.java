...
public class ShareZtreeServiceImpl implements ShareService<ZTreeNode> {
     ...
     */
    @Override
    public List<ZTreeNode> showShareByUsername(String username) {
    ...
    private void parseShare2Tree(List<Note> notes, List<Directory> directories, List<ZTreeNode> zTreeNodes, int pid) {
        ...
        for (Directory directory : directories) {
            if (directory.getParentId() == pid) {
                zTreeNodes.add(new ZTreeNode(directory.getParentId() * 2 + 1, directory.getParentId() * 2 + 1, directory.getDirName(), true));
                parseShare2Tree(notes, directories, zTreeNodes, directory.getId());
            }
        }
    ...
    public List<ZTreeNode> showShareByUrl(String url) {
     ...
     */
    @Override
    public void deleteShare(int shareId, String username) {
     ...
     */
    @Override
    public Share addShare(int DirectoryOdNoteId, int shareType, String username) {
