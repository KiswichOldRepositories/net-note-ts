...
public interface AttachService {
     ...
     */
    ReturnFile downloadAttach(int attachId, String username) throws Exception;
     ...
     * @param username 请求者的用户名
     */
    void uploadAttach(ReturnFile returnFile,int noteId,String username) throws Exception;
     ...
     * @param username  请求者的用户名
     */
    void deleteAttachById(int attachId,String username) throws Exception;
