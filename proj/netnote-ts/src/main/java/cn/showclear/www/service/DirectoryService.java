...
public interface DirectoryService {
     ...
     */
    List showDirectories(String username) throws Exception;
     ...
     * @return
     */
    void deleteDirectory(int directoryId,String username) throws  Exception;
     ...
     * @param username 请求者的用户名
     */
    Directory addDirectory(int parentDirectoryId,String newDirectoryName,String username) throws Exception;
     ...
     * @param username 请求者的用户名
     */
    Directory editDirectory(Directory directory,String username) throws Exception;
