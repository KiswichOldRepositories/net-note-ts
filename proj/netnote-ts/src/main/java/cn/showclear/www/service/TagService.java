...
public interface TagService<E>{
     ...
     */
    Tag addTag(String tagName, int noteId, String username) throws Exception;
     ...
     */
    Note addTags(List<Tag> tags,int noteId,String username) throws Exception;
     ...
     */
    void deleteTag(int tagId,int noteId,String username) throws Exception;
     ...
     * @return
     */
    List<TagFromWeb> showTag(int noteId,String username) throws Exception;
     ...
     * @return
     */
    List<E> searchByTags(String tagNames, String username) throws Exception;
}
