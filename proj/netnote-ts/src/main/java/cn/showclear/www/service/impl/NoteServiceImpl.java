...
public class NoteServiceImpl implements NoteService {
     ...
     */
    @Override
    public Note addNote(Note note, String username) throws Exception {
        //验证要添加到的文件夹是否属于用户的
     ...
     */
    @Override
    public void deleteNote(int deletedNoteId, String username) throws Exception {

        //验证笔记的所有权

        Note deletedNote = noteDao.selectNoteById(deletedNoteId);
        User user = userDao.selectUserByUsername(username);
        if (user == null || deletedNote == null || user.getId() != deletedNote.getUserId())
            throw new Exception("用户或者笔记错误");
     ...
     */
    @Override
    public Note editNote(Note editNote, String username) throws Exception{
     ...
     */
    @Override
    public Note getNote(int noteId, String username)throws Exception {
