define(["require", "exports", "scooper.ajax"], function (require, exports, scooper_ajax_1) {
    "use strict";
    ...
    var NotePage = /** @class */ (function () {
        ...
        NotePage.prototype.newNote = function () {
            var url = "22";
            new scooper_ajax_1.Ajax("").request(url)
         ...
         * 刷新树 传入与服务器交互的url
         */
        NotePage.prototype.freshTree = function (url) {
            var setting = {
                data: {
                    simpleData: {
                        enable: true,
            ...
            var ajax = new scooper_ajax_1.Ajax("");
            //ajax.setPath("tree", url);
            var promise = ajax.request(url).then(function (result) {
         ...
         * 1.树的双击事件
         */
        NotePage.prototype.bindTreeDoubleClick = function (event, treeId, treeNode) {
            // console.log(event);
            // console.log(treeId);
